...
namespace ParkingLotDesign
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while(true)
            {
                Console.WriteLine("Select 1 to Enter a Vehicle, 2 to Exit a Vehicle");
                string choice = Console.ReadLine();
                switch(choice)
                {
                    case "1":
                        EnterVehicle(parkingLot, vehicles);
                        break;
                    case "2":
                        ExitVehicle(parkingLot, vehicles);
                        break;
                    default:
        ...
        static  void EnterVehicle(ParkingLot parkingLot, Dictionary<string, Ticket> vehicles)
        {
        ...
        static void ExitVehicle(ParkingLot parkingLot, Dictionary<string, Ticket> vehicles)
        {
